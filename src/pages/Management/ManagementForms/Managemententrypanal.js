    ...
    <>
      <div className={`lg:w-full lg:h-full lg:flex lg:justify-center lg:items-center`}>
        <div className={`lg:w-[95%] lg:h-[90%] lg:flex lg:justify-start lg:items-center lg:flex-col`}>
            <div className={`lg:h-auto lg:w-full lg:text-3xl lg:flex lg:justify-center lg:items-start lg:font-semibold lg:text-gray-400 lg:subpixel-antialiased`}>ADD ROLE</div>
            <div className={`lg:h-[85%] lg:w-full lg:flex lg:justify-start lg:items-center lg:flex-col lg:gap-2 mt-5`}>
