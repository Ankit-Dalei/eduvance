        ...
        <>
          <div className={` lg:h-full lg:w-full lg:flex lg:justify-center lg:items-center`}>
            <div className={`lg:h-full lg:w-[95%] lg:flex lg:justify-between lg:items-center lg:flex-row`}>
              <div className={` lg:h-[35px] lg:w-[35px] lg:rounded-full lg:flex lg:justify-center lg:items-center hover:bg-slate-300 cursor-pointer `} onClick={()=>dispatch(changestate())}><FontAwesomeIcon icon={faBars} size="xl" className={`text-black `} /></div>
