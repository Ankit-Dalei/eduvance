        ...
        <>
          <div className={` lg:h-full lg:w-full lg:flex lg:justify-center lg:items-center lg:relative`}>
            <div className={`lg:h-full lg:w-[95%] lg:flex lg:justify-between lg:items-center lg:flex-row `}>
              <div className={` lg:h-[25px] lg:w-[27px] lg:rounded-full lg:flex lg:justify-center lg:items-center hover:border-gray-500 cursor-pointer lg:absolute lg:left-[-20px] lg:border-solid lg:border-2 lg:border-gray-300 lg:hover:text-gray-500 lg:text-gray-300`} onClick={handelclick}>
                {isState?<FontAwesomeIcon icon={faChevronRight} size="sm" />:<FontAwesomeIcon icon={faChevronLeft} />}
              </div>
