    ...
    <>
      <div className={`h-[100%] w-[100%] flex justify-center items-center flex-col`}>
        <div className={`h-[100%] w-[100%] flex justify-start items-center flex-col`}>
          ...
          <button className={`${count? 'bg-slate-300 h-[40px] w-[160px] rounded-lg text-lg font-mono hover:bg-slate-800 hover:text-slate-50' :'h-[35px] w-[35px] rounded-lg text-gray-500 hover:bg-slate-300 hover:text-red-500 text-xl'}`}>{count?'Logout':<FontAwesomeIcon icon={faRightFromBracket}/>}</button> 
          </div>
        </div>
      </div>
    </>
