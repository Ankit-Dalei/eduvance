      ...
      <div className={`h-full`}>
        ...
        <div className={`h-[60%] flex justify-center items-center`}>
          <ul className=' h-[90%] w-[100%] flex flex-col  items-center gap-[5px]'>
            <Link to={``} className={` w-[85%] flex justify-start items-center text-2xl`}><div className={`w-[25%]`}><FontAwesomeIcon icon={faHouse} size="xs" className={`text-white `}/></div> <div className={`w-[70%]`}><li className={`text-white`}>Home</li></div></Link>
        ...
        <div className={`h-[15%] flex justify-center xl:items-center`}>
