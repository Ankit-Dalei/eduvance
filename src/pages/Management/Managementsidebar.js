    ...
    <>
      <div className={`lg:h-[100%] lg:w-[100%] lg:flex lg:justify-center lg:items-center lg:flex-col`}>
        <div className={`lg:h-[100%] lg:w-[100%] bg-slate-900 lg:flex lg:justify-between lg:items-center lg:flex-col`}>
          ...
          <Link to={``} title={`home`} className={`lg:h-[35px] lg:w-[35px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-red-500 ${isActive('/management') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faHouse} size="xs"/></Link>
          <Link to={`School`} title={`School`} className={`lg:h-[35px] lg:w-[35px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-red-500 ${isActive('/management/School') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faGraduationCap} size="xs"/></Link>
          <Link to={`Branch`} title={`Branch`} className={`lg:h-[35px] lg:w-[35px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-red-500 ${isActive('/management/Branch') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faCodeBranch} size="xs"/></Link>
          <Link to={`Course`} title={`Course`} className={`lg:h-[30px] lg:w-[35px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-red-500 ${isActive('/management/Course') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faBook} size="xs"/></Link>
          <Link to={`Teacher`} title={`Teacher`} className={`lg:h-[35px] lg:w-[35px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-red-500 ${isActive('/management/Teacher') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faPersonChalkboard} size="xs"/></Link>
          <Link to={`Student`} title={`Student`} className={`lg:h-[35px] lg:w-[35px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-red-500 ${isActive('/management/Student') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faPersonPraying} size="xs"/></Link>
          <Link to={`Section`} title={`Section`} className={`lg:h-[35px] lg:w-[35px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-red-500 ${isActive('/management/Section') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faChalkboardUser} size="xs"/></Link>
        </ul>
          }
          </div>
