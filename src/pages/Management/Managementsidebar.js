      ...
      <div className={`lg:h-[100%] lg:w-[100%] lg:flex lg:justify-center lg:items-center lg:flex-col`}>
        <div className={`lg:h-[100%] lg:w-[100%] bg-slate-900 lg:flex lg:justify-between lg:items-center lg:flex-col`}>
          ...
          {count?<ul className='lg:h-[95%] lg:w-[100%] lg:flex lg:justify-start lg:items-center lg:flex-col space-y-5'>
            <Link to={``} className={`lg:h-[30px] lg:w-[80%] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 hover:text-red-500 rounded-xl lg:text-xl ${isActive('/management') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><div className={`w-[20%]`}><FontAwesomeIcon icon={faHouse} size="xs"/></div> <div className={`w-[70%]`}><li className={`lg:text-sm lg:font-semibold`}>Home</li></div></Link>
            <Link to={`School`} className={`lg:h-[30px] lg:w-[80%] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 hover:text-red-500 rounded-xl lg:text-xl ${isActive('/management/School') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><div className={`w-[20%]`}><FontAwesomeIcon icon={faGraduationCap} size="xs"/></div> <div className={`w-[70%]`}><li className={`lg:text-sm lg:font-semibold`}>School</li></div></Link>
            <Link to={`Branch`} className={`lg:h-[30px] lg:w-[80%] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 hover:text-red-500 rounded-xl lg:text-xl ${isActive('/management/Branch') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><div className={`w-[20%]`}><FontAwesomeIcon icon={faCodeBranch} size="xs"/></div> <div className={`w-[70%]`}><li className={`lg:text-sm lg:font-semibold`}>Branch</li></div></Link>
            ...
            <Link to={`Student`} className={`lg:h-[30px] lg:w-[80%] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 hover:text-red-500 rounded-xl lg:text-xl ${isActive('/management/Student') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><div className={`w-[20%]`}><FontAwesomeIcon icon={faPersonPraying} size="xs"/></div> <div className={`w-[70%]`}><li className={`lg:text-sm lg:font-semibold`}>Student</li></div></Link>
          ...
          <Link to={``} title={`home`} className={`lg:h-[30px] lg:w-[30px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-xl lg:text-xl hover:text-red-500 ${isActive('/management') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faHouse} size="xs"/></Link>
          <Link to={`School`} title={`School`} className={`lg:h-[30px] lg:w-[30px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-xl lg:text-xl hover:text-red-500 ${isActive('/management/School') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faGraduationCap} size="xs"/></Link>
          <Link to={`Branch`} title={`Branch`} className={`lg:h-[30px] lg:w-[30px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-xl lg:text-xl hover:text-red-500 ${isActive('/management/Branch') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faCodeBranch} size="xs"/></Link>
          <Link to={`Course`} title={`Course`} className={`lg:h-[30px] lg:w-[30px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-xl lg:text-xl hover:text-red-500 ${isActive('/management/Course') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faBook} size="xs"/></Link>
          <Link to={`Teacher`} title={`Teacher`} className={`lg:h-[30px] lg:w-[30px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-xl lg:text-xl hover:text-red-500 ${isActive('/management/Teacher') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faPersonChalkboard} size="xs"/></Link>
          <Link to={`Student`} title={`Student`} className={`lg:h-[30px] lg:w-[30px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-xl lg:text-xl hover:text-red-500 ${isActive('/management/Student') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faPersonPraying} size="xs"/></Link>
          <Link to={`Section`} title={`Section`} className={`lg:h-[30px] lg:w-[30px] lg:flex lg:justify-center lg:items-center hover:bg-slate-300 rounded-xl lg:text-xl hover:text-red-500 ${isActive('/management/Section') ? 'bg-slate-300 text-black' : 'lg:text-slate-50'}`}><FontAwesomeIcon icon={faChalkboardUser} size="xs"/></Link>
        </ul>
          }
          </div>
