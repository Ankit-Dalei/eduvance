            ...
            <ul className={`flex flex-col -mt-20 space-y-3 w-1 xl:w-auto`}>
              ...
              <li className="mb-2 hover:bg-purple-500 py-2 rounded-2xl">
                <Link to="/list" className="px-[0.5rem]">
                  ...
                  {!isCollapsed ? (
                    <span className="xl:inline-block hidden">University</span>
                  ) : (
                    ""
                  )}
                </Link>
              ...
              <li className="mb-2 hover:bg-purple-500 py-2 rounded-2xl">
                <Link to="/manage" className="px-[0.5rem]">
                  ...
                  {!isCollapsed ? (
                    <span className="xl:inline-block hidden">Management</span>
                  ) : (
                    ""
                  )}
                </Link>
              ...
              <li className="mb-2 hover:bg-purple-500 py-2 rounded-2xl">
                <Link to="/campus" className="px-[0.5rem]">
                  ...
                  {!isCollapsed ? (
                    <span className="xl:inline-block hidden">Campus</span>
                  ) : (
                    ""
                  )}
                </Link>
              ...
              <li className="mb-2 hover:bg-purple-500 py-2 rounded-2xl">
                <Link to="/report" className="px-[0.5rem]">
                  ...
                  {!isCollapsed ? (
                    <span className="xl:inline-block hidden">Report</span>
                  ) : (
                    ""
                  )}
                </Link>
              ...
              <li className="mb-2 hover:bg-purple-500 py-2 rounded-2xl">
                <Link to="/setting" className="px-[0.5rem]">
                  ...
                  {!isCollapsed ? (
                    <span className="xl:inline-block hidden">Setting</span>
                  ) : (
                    ""
                  )}
                </Link>
              </li>
              <li className="mb-2 hover:bg-purple-500 py-2 rounded-2xl fixed bottom-0 w-full xl:relative xl:bottom-0 xl:w-full">
  <Link to="/" className="px-[0.5rem]">
    ...
    {!isCollapsed ? (
      ...
      ""
          ...
          <div className="w-[250%] xl:w-[100%] bg-white p-12 xl:overflow-auto overflow-y-auto xl:h-[98%] h-[80%] ml-3 xl:-mt-8 md:rounded-xl">
            {children}
          </div>
              ...
              <div className="space-y-6 text-center text-ellipsis">
                ...
                <div className="flex flex-col space-y-3 ">
                  <button
                    ...
                    onClick={() => handleCreateRole('Management')}
                  >
                  ...
                  <button
                    className="mx-16 py-3 bg-gray-300 rounded-2xl"
                    onClick={() => handleCreateRole('Campus')}
                  >
                    <BiBuildingHouse className="inline-block w-6 h-6 mr-2 -mt-2" />
                    University
                  </button>
                  <button
                    className="mx-16 py-3 bg-gray-300 rounded-2xl"
                    onClick={() => handleCreateRole('University')}
                  >
