...
import { faGraduationCap, faBook, faPersonChalkboard,faPlus, faRightFromBracket, faHouse, faChevronRight, faChevronLeft, faUserTie, faSchool } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className={`h-[100%] w-[100%] flex justify-start items-center flex-col `}>
          ...
          <div className={`h-[70%] w-[100%] flex justify-center items-center font-thin`}>
            ...
            {count ? <ul className='h-[95%] w-[100%] flex justify-start items-center flex-col sm:space-y-5 space-y-2'>
              ...
              <Link to={`University`} className={`h-[35px] w-[80%] flex justify-center items-center hover:bg-slate-300 hover:text-green-400 rounded-xl lg:text-xl  sm:w-[85%] sm:text-sm ${isActive('/admin/University') ? 'bg-slate-300 text-black' : 'text-gray-400'}`}><div className={`w-[20%]`}><FontAwesomeIcon icon={faSchool} size="xs" /></div> <div className={`w-[70%]`}><li className={`sm:text-sm font-semibold font-serif`}>University</li></div></Link>
              ...
              <Link to={`degree`} className={`h-[35px] w-[80%] flex justify-center items-center hover:bg-slate-300 hover:text-green-400 rounded-xl lg:text-xl  sm:w-[85%] sm:text-sm ${isActive('/admin/degree') ? 'bg-slate-300 text-black' : 'text-gray-400'}`}><div className={`w-[20%]`}><FontAwesomeIcon icon={faGraduationCap} size="xs" /></div> <div className={`w-[70%]`}><li className={`sm:text-sm font-semibold font-serif`}>Degree</li></div></Link>
              ...
              <span  className={`cursor-pointer h-[35px] w-[80%] flex justify-center items-center hover:bg-slate-300 hover:text-green-400 rounded-xl lg:text-xl  sm:w-[85%] sm:text-sm ${isActive('') ? 'bg-slate-300 text-black' : 'text-gray-400'}`} onClick={handleLogout}><div className={`w-[20%]`}><FontAwesomeIcon icon={faRightFromBracket} size="xs" /></div> <div className={`w-[70%]`}><li className={`sm:text-sm font-semibold font-serif`}>Logout</li></div></span>
            </ul>
              :
              <ul className='sm:h-[95%] sm:w-[100%] sm:flex sm:justify-start sm:items-center sm:flex-col space-y-5 md:space-y-3 sm:space-y-2 hidden'>
                ...
                <Link to={`University`} title={`University`} className={`sm:h-[35px] sm:w-[35px] sm:flex sm:justify-center sm:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-green-400  sm:text-sm ${isActive('/admin/University') ? 'bg-slate-300 text-black' : 'text-gray-400'}`}><FontAwesomeIcon icon={faSchool} size="xs" /></Link>
                ...
                <Link to={`degree`} title={`degree`} className={`sm:h-[35px] sm:w-[35px] sm:flex sm:justify-center sm:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-green-400  sm:text-sm ${isActive('/admin/degree') ? 'bg-slate-300 text-black' : 'text-gray-400'}`}><FontAwesomeIcon icon={faGraduationCap} size="xs" /></Link>
                <Link to={``} title={``} className={`sm:h-[35px] sm:w-[35px] sm:flex sm:justify-center sm:items-center hover:bg-slate-300 rounded-lg lg:text-xl hover:text-green-400  sm:text-sm ${isActive('') ? 'bg-slate-300 text-black' : 'text-gray-400'}`} onClick={handleLogout}><FontAwesomeIcon icon={faRightFromBracket} size="xs" /></Link>
              </ul>
            }
          </div>
        </div>
