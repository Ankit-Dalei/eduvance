...
const List = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <>
          <Button onClick={() => showEditModal(record)} style={{ marginRight: 8 }} className='bg-blue-500'>
            <EditOutlined/>
            Edit
          </Button>
  ...
  return (
    <Sidebar>
      ...
      <Table rowSelection={rowSelection} columns={columns} dataSource={data} pagination={{ pageSize: 4 }} className='text-center' />
