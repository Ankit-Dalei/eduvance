  ...
  return (
    <>
        <div className={`bg-slate-900 sm:h-screen sm:w-full flex justify-center items-center flex-row relative h-screen w-full`}>
          <div className={`bg-gray-100 h-full sm:block ${count? 'lg:w-[18%]' : 'lg:w-[8%]'} ${count? 'md:w-[25%]' : 'md:w-[10%]'} ${count? 'sm:w-[25%]' : 'sm:w-[10%]'} md:relative absolute left-0 z-[1]  ${count? 'w-[50%]' : 'w-[0%] hidden'} `}>
            <Adminsidebar/>
          </div>
